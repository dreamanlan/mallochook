...
namespace ElfPatch
{
    public static class ScriptProcessor
    {
        ...
        public static void Init()
        {
            ...
            s_Calculator.Register("adddllcall", new ExpressionFactoryHelper<AddDllCallCommand>());
        ...
        public static void AddDllCall(string so, string func, string arg)
        {
            if (null != s_CurFile) {
                s_CurFile.AddDllCall(so, func, arg);
            }
        }
